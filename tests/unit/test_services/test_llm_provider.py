...
from services.llm_provider import AnthropicProvider, LLMMessage, LLMService, OllamaProvider, OpenAIProvider
...
class TestLLMService:
    ...
    def test_llm_service_initialization_anthropic(self):
        ...
        config = {"provider": "anthropic", "model": "claude-3-5-sonnet-20241022", "api_key": "test-key"}
    ...
    def test_llm_service_invalid_provider(self):
        ...
        config = {"provider": "invalid_provider", "model": "test-model"}
    ...
    async def test_analyze_failure_success(self):
        ...
        with patch.object(
            service.provider, "generate", new_callable=AsyncMock, return_value=mock_llm_response
        ) as mock_generate:
