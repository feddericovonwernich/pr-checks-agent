...
from src.tools.claude_tool import ClaudeCodeInput, ClaudeCodeTool
...
class TestClaudeCodeTool:
    ...
    def test_claude_tool_unknown_operation(self, mock_subprocess):
        ...
        result = tool._run(
            operation="unknown_operation", failure_context="test context", check_name="CI", pr_info={"number": 123}
        )
    ...
    async def test_analyze_failure_with_context(self, mock_subprocess):
        ...
        result = await tool._arun(
            ...
            pr_info={"number": 789, "title": "Add new feature", "branch": "feature/new-functionality", "author": "developer"},
            project_context={"project_type": "python", "package_manager": "pip", "requirements_file": "requirements.txt"},
        )
    ...
    async def test_fix_issue_with_repository_path(self, mock_subprocess):
        ...
        result = await tool._arun(
            ...
            check_name="ESLint",
            pr_info={"number": 101, "title": "JavaScript improvements", "branch": "feature/js-fixes"},
